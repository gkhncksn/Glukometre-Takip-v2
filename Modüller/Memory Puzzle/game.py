...
for img in range(1,21):
	image = pygame.image.load(f"Modüller\\Memory Puzzle\\Assets\\icons\\{img}.jpeg")
	image = pygame.transform.scale(image, (TILESIZE,TILESIZE))
	img_list.append(image)

bg = pygame.image.load('Modüller\\Memory Puzzle\\Assets\\bg.jpg')
game_won = pygame.image.load('Modüller\\Memory Puzzle\\Assets\\won.png')
rightbar = pygame.image.load('Modüller\\Memory Puzzle\\Assets\\image.jpg')
rightbar = pygame.transform.scale(rightbar, (280, HEIGHT - 47))

### Loading Sounds ************************************************************
pygame.mixer.music.load('Modüller\\Memory Puzzle\\Sounds\\Puzzle-Game-3_Looping.mp3')
pygame.mixer.music.set_volume(0.4)
pygame.mixer.music.play(loops=-1)

card_click = pygame.mixer.Sound("Modüller\\Memory Puzzle\\Sounds\\card click.wav")
woosh = pygame.mixer.Sound("Modüller\\Memory Puzzle\\Sounds\\woosh.mp3")

### Buttons *******************************************************************
restart_img = pygame.image.load('Modüller\\Memory Puzzle\\Assets\\restart.png')
restart_btn = Button(restart_img, (40,40), 720, 230)

info_img = pygame.image.load('Modüller\\Memory Puzzle\\Assets\\info.png')
info_btn = Button(info_img, (40,40), 720, 280)

close_img = pygame.image.load('Modüller\\Memory Puzzle\\Assets\\close.png')
close_btn = Button(close_img, (40,40), 720, 330)

### LOADING FRUITS INFORMATION ************************************************
with open('Modüller\\Memory Puzzle\\Info\\info.json') as f:
	dct = json.load(f)
