...
fondo = pygame.image.load('Modüller\\Space Invaders\\imagenes\\fondo.png')
laser_sonido = pygame.mixer.Sound('Modüller\\Space Invaders\\laser.wav')
explosion_sonido = pygame.mixer.Sound('Modüller\\Space Invaders\\explosion.wav')
golpe_sonido = pygame.mixer.Sound('Modüller\\Space Invaders\\golpe.wav')

explosion_list = []
for i in range(1,13):
	explosion = pygame.image.load(f'Modüller\\Space Invaders\\explosion\\{i}.png')
...
class Jugador(pygame.sprite.Sprite):
	def __init__(self):
		super().__init__()
		self.image = pygame.image.load('Modüller\\Space Invaders\\imagenes\\A1.png').convert_alpha()
...
class Enemigos(pygame.sprite.Sprite):
	def __init__(self, x, y):
		super().__init__()
		self.image = pygame.image.load('Modüller\\Space Invaders\\imagenes\\E1.png').convert_alpha()
		self.rect = self.image.get_rect()
...
class Balas(pygame.sprite.Sprite):
	def __init__(self, x, y):
		super().__init__()
		self.image = pygame.image.load('Modüller\\Space Invaders\\imagenes\\B2.png').convert_alpha()
		self.rect = self.image.get_rect()
		self.rect.centerx = x
		self.rect.y = y
		self.velocidad = -18
...
class Balas_enemigos(pygame.sprite.Sprite):
	def __init__(self, x, y):
		super().__init__()
		self.image = pygame.image.load('Modüller\\Space Invaders\\imagenes\\B1.png').convert_alpha()
