...
class Grumpy:
	def __init__(self, win):
		...
		for i in range(1,4):
			img =  pygame.image.load(f'Modüller\\Flappy Bird\\Assets\\Grumpy\\{bird_color}{i}.png')
...
class Base:
	def __init__(self, win):
		...
		self.image1 = pygame.image.load('Modüller\\Flappy Bird\\Assets\\base.png')
...
class Score:
	def __init__(self, x, y, win):
		...
		for score in range(10):
			img = pygame.image.load(f'Modüller\\Flappy Bird\\Assets\\Score\\{score}.png')
