...
bg1 = pygame.image.load('Modüller\\Flappy Bird\\Assets\\background-day.png')
bg2 = pygame.image.load('Modüller\\Flappy Bird\\Assets\\background-night.png')

bg = random.choice([bg1, bg2])

im_list = [pygame.image.load('Modüller\\Flappy Bird\\Assets\\pipe-green.png'), pygame.image.load('Modüller\\Flappy Bird\\Assets\\pipe-red.png')]
pipe_img = random.choice(im_list)

gameover_img =  pygame.image.load('Modüller\\Flappy Bird\\Assets\\gameover.png')
flappybird_img =  pygame.image.load('Modüller\\Flappy Bird\\Assets\\flappybird.png')
flappybird_img = pygame.transform.scale(flappybird_img, (200,80))

# Sounds & fx


die_fx = pygame.mixer.Sound('Modüller\\Flappy Bird\\Sounds\\die.wav')
hit_fx = pygame.mixer.Sound('Modüller\\Flappy Bird\\Sounds\\hit.wav')
point_fx = pygame.mixer.Sound('Modüller\\Flappy Bird\\Sounds\\point.wav')
swoosh_fx = pygame.mixer.Sound('Modüller\\Flappy Bird\\Sounds\\swoosh.wav')
wing_fx = pygame.mixer.Sound('Modüller\\Flappy Bird\\Sounds\\wing.wav')
